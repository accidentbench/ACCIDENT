...
- [heuristic_baselines/](heuristic_baselines/) — Heuristic baseline solutions (optical flow, bounding box dynamics, ensemble) with notebooks and standalone scripts.
